                ...
                <div class="awardsSlider">
                  <div>
                    <div class="flagImg">
                      ...
                      <h6>2018 <br/> <small>Design Conclave</small></h6>
                    </div>
                  </div>
                  <div>
                    <div class="flagImg">
                      <h4>Top 15 <br/><span>Web development companies in India</span> </h4>
                      <h6>2018 <br/><small>Clutch</small></h6>
                    </div>
                  </div>
                  <div>
                    <div class="flagImg">
                      <h4>50 Most <br/> <span>influential Global Youth Leader </span> </h4>
                      <h6>2017<br/> <small>World HRD conference</small></h6>
                    </div>
                  </div>
                  <div>
                    <div class="flagImg">
                      <h4>Rising star<br/> <span>Award</span> </h4>
                      <h6>2018<br/> <small>FinancesOnline</small></h6>
                    </div>
                  </div>
                  <div>
                    <div class="flagImg">
