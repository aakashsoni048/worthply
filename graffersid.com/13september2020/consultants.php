          ...
          <div class="container">
            ...
            <div>
             <form  action="" method="post">
              ...
              <div id="submit_form" >
                 <h2 style="color: #000000;font-size: 30px;font-weight: 200;text-transform: none;line-height: 1.8;position: relative;display: inline-block;background-color: #FFF;padding-bottom: 30px;">Your details have stored successfully.</h2>      
              </div>
...
<script>
  $(document).ready(function(){
    ...
    messages :{
        ...
        "Position" : {
            required : 'Enter valid Position name'
        },
        "Company" : {
            required : 'Enter valid Company name'
        },
        "Experience" : {
            required : 'Enter valid Experience name'
        },
        "Current_CTC" : {
            required : 'Enter valid Current_CTC name'
        },
        "Expected_CTC" : {
            required : 'Enter valid Expected_CTC name'
        },
        "Notice_Period" : {
            required : 'Enter valid Notice_Period name'
        },
        "feedback" : {
            required : 'Enter your Feedback please'
        }
    },

    submitHandler: function(form) {
          $.ajax({
            url:"https://graffersid.com/submit-check-availability/",
            type:"POST",
            data: $(form).serialize(),
            success: function(response){
              if(response == 1)
